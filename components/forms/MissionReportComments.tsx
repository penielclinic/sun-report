...
import type { MissionReportComment } from "@/types/database";
...
export default function MissionReportComments({
  reportId,
  initialComments,
  currentUserId,
  canComment,
  ...
  reportId: string;
  initialComments: MissionReportComment[];
  ...
  async function handleSend() {
    ...
    setSending(true);
    try {
      const res = await fetch(`/api/reports/mission/${reportId}/comments`, {
        method: "POST",
